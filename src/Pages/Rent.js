        ...
        <form onSubmit={searchHandler} className="flex items-center gap-x-4">
          ...
          <div className="px-4 border-r border-gray-300 flex-1">
            ...
            <select
              ...
              className="focus:outline-none font-semibold appearance-none cursor-pointer  w-24">
          ...
          <div className="px-4 flex justify-center items-center">
            <button
              type="submit"
              className="px-6 py-2 text-white bg-purple-500 rounded-md font-medium cursor-pointer">
              Search
            </button>
          </div>
        </form>
